...
import 'package:widget_test_app/models/customers.dart';

class GeneratePdf {
  static createPdf(Customers customer) async {
    ...
    page.graphics.drawString(
      ...
      bounds: Rect.fromLTWH(10, 10, 100, 60)
      );
    List<int> bytes = await document.save();

    if (kIsWeb) {
      // generateWebPdf(bytes, receiptDetail.receiptNo.toString());
